...
#define INITIAL_ADV_TIMEOUT            (10*1000*1000/CFG_TS_TICK_VAL) /**< 10s */
...
void APP_BLE_Init(void)
{
  ...
  */
  ...
  while (__HAL_TIM_GET_COUNTER(&htim2) < 11900){
...
static void Ble_Hci_Gap_Gatt_Init(void)
{
  ...
  // set scan and advertising parameters
