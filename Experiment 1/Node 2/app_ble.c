...
#define SCAN_TIMEOUT                   (30*1000*1000/CFG_TS_TICK_VAL)  // 30s
...
static void Adv_Request(void)
{
  ...
  service_data[0] = 5;											/*< Length. */
  service_data[1] = AD_TYPE_SERVICE_DATA;							/*< Service Data data type value. */
  service_data[2] = 0x1A;											/*< temperature measurement UUID. */
  service_data[3] = 0X18;											/*< temperature measurement UUID. */
  service_data[4] = node;
